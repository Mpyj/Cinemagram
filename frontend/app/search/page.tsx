  ...
  return (
    <>
      ...
      <main>
        ...
        <div className="section" style={{ maxWidth: '700px', margin: '0 auto', paddingTop: '10px' }}>
          {/* باکس جستجو */}
          <div className="search-box" style={{ width: '100%', padding: '12px 20px', borderRadius: '50px', marginBottom: '15px' }}>
          ...
          <button
            ...
            style={{ padding: '8px 20px', fontSize: '0.8rem', marginBottom: '15px' }}
          >
